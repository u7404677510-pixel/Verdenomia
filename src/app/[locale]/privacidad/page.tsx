...
const content = {
  es: {
    ...
    sections: [
      { title: '1. Responsable del tratamiento', content: 'VERDENOMIA S.L., con CIF B-12345678, domicilio en Calle Principal, 123, 03001 Alicante, España. Email: info@verdenomia.es' },
      ...
      { title: '6. Derechos', content: 'Puede ejercer sus derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad enviando un email a info@verdenomia.es con copia de su DNI.' },
  ...
  fr: {
    ...
    sections: [
      { title: '1. Responsable du traitement', content: 'VERDENOMIA S.L., avec CIF B-12345678, domicilié Calle Principal, 123, 03001 Alicante, Espagne. Email : info@verdenomia.es' },
      { title: '2. Finalité du traitement', content: 'Vos données personnelles seront traitées pour : gérer votre demande d\'information, évaluer votre éligibilité au programme CAE, programmer des visites techniques, envoyer des communications commerciales (avec votre consentement), et respecter les obligations légales.' },
      { title: '3. Base légale', content: 'Le traitement est basé sur : votre consentement, l\'exécution d\'un contrat ou de mesures précontractuelles, et le respect des obligations légales applicables.' },
      { title: '4. Destinataires', content: 'Vos données peuvent être communiquées à : des entreprises énergétiques pour la gestion des CAE, des administrations publiques lorsque la loi l\'exige, et des prestataires de services agissant en tant que sous-traitants.' },
      { title: '5. Conservation', content: 'Les données seront conservées pendant le temps nécessaire à la réalisation de la finalité pour laquelle elles ont été collectées et, ensuite, pendant les délais légaux de prescription.' },
      { title: '6. Droits', content: 'Vous pouvez exercer vos droits d\'accès, de rectification, de suppression, d\'opposition, de limitation et de portabilité en envoyant un email à info@verdenomia.es avec une copie de votre pièce d\'identité.' },
      { title: '7. Réclamations', content: 'Si vous estimez que vos droits n\'ont pas été correctement respectés, vous pouvez déposer une réclamation auprès de l\'Agence Espagnole de Protection des Données (www.aepd.es).' },
    ],
  },
  en: {
    ...
    sections: [
      { title: '1. Data Controller', content: 'VERDENOMIA S.L., with CIF B-12345678, located at Calle Principal, 123, 03001 Alicante, Spain. Email: info@verdenomia.es' },
      ...
      { title: '6. Rights', content: 'You can exercise your rights of access, rectification, deletion, opposition, limitation and portability by sending an email to info@verdenomia.es with a copy of your ID.' },
